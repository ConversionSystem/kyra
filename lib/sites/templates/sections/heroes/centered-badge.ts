...
export function centeredBadgeHero(data: HeroData): string {
  ...
  <div class="relative z-10 max-w-5xl mx-auto px-6 py-24 sm:py-36 text-center w-full">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
      <a href="${data.ctaLink || data.bookingUrl || '#contact'}" class="inline-flex items-center justify-center gap-2 font-bold px-10 py-4 rounded-xl text-lg shadow-2xl transition-all hover:scale-105" style="background: #ffffff; color: ${data.colors.primary};">${data.ctaText || 'Get Free Quote'}</a>
