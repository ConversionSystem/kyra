  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 py-24 sm:py-32 w-full">
    <div class="max-w-3xl">
      ...
      <div class="flex flex-wrap gap-4 mb-10">
        ...
        ${data.bookingUrl ? `<a href="${data.bookingUrl}" class="inline-flex items-center gap-3 border-2 border-white/80 text-white font-semibold px-8 py-4 rounded-xl text-lg transition-all hover:bg-white/15" style="backdrop-filter: blur(8px);">${calendarIcon()} Book Online</a>` : ''}
      </div>
      <!-- Trust strip -->
