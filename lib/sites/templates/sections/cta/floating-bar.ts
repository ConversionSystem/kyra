...
export function floatingBarCta(data: CtaData): string {
  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3 flex-wrap">
    ...
    <!-- CTAs -->
    <div class="flex items-center gap-3 flex-wrap flex-1 sm:flex-none justify-center sm:justify-start">
