...
<section class="py-16 sm:py-24 px-4" style="background: linear-gradient(135deg, ${data.colors.primary}, ${data.colors.secondary});" aria-label="Call to action">
  <div class="max-w-4xl mx-auto text-center">
    ...
    ${data.bookingUrl ? `<div class="mt-4"><a href="${data.bookingUrl}" class="inline-flex items-center justify-center px-8 py-3 rounded-lg text-lg font-semibold transition-opacity hover:opacity-90" style="background: #ffffff; color: ${data.colors.primary};">Book Online</a></div>` : ''}
