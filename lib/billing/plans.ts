...
export const PLANS: Record<Plan, PlanConfig> = {
  ...
  starter: {
    ...
    monthlyCredits: 500,
    trialDays: 0,
    description: 'Launch your agency with 3 clients — each gets a full Business in a Box.',
    features: [
      '3 clients — website + AI worker + CRM each',
      'AI Website Builder — 15-25 SEO-optimized pages per client',
      '500 platform credits / month',
      'AI chat widget trained on each client\'s business',
      'Lead capture + CRM (contacts, pipeline, deals)',
      'GHL integration',
      'Multi-channel messaging (SMS, Telegram, web chat)',
      'Growth Engine — AI-suggested SEO pages',
  ...
  pro: {
    ...
    monthlyCredits: 1500,
    trialDays: 0,
    description: 'For growing agencies — 10 clients, each with the full Business in a Box.',
    features: [
      '10 clients — website + AI worker + CRM each',
      'AI Website Builder — 15-25 SEO-optimized pages per client',
      '1,500 platform credits / month',
      'Everything in Lite',
      'White-label branding',
      'Custom AI personalities per client',
      'Advanced conversations inbox',
  ...
  scale: {
    ...
    monthlyCredits: 2500,
    trialDays: 0,
    description: 'Built for high-volume agencies — 30 clients, full Business in a Box.',
    features: [
      '30 clients — website + AI worker + CRM each',
      'AI Website Builder — 15-25 SEO-optimized pages per client',
      '2,500 platform credits / month',
      'Everything in Pro',
      'Dedicated infrastructure',
      'Custom domain per client site',
