...
`,
  },
  {
    ...
    description: 'Your complete AI marketing team — SEO research, content creation, competitor intelligence, social media drafting, lead spotting, email outreach, and performance analytics. 8 specialized modes, daily automated routines, all outputs sent for your approval.',
    tags: ['marketing', 'seo', 'content', 'social-media', 'competitor', 'analytics', 'lead-gen', 'email', 'brand'],
    whatItDoes: [
      'Researches keywords, tracks rankings, finds content gaps and quick-win SEO opportunities',
      'Drafts LinkedIn posts, Twitter/X threads, blog articles, newsletters, and video scripts in your brand voice',
      'Monitors competitor websites with live web browsing — detects new content, pricing changes, and keyword overlap',
      'Monitors industry RSS feeds and blogs daily — surfaces relevant news, trends, and opportunities',
      'Drafts thoughtful engagement comments for target accounts on LinkedIn (you approve and post)',
      'Spots marketing leads from content engagement and web signals — flags buying intent with context',
      'Drafts cold outreach emails, follow-up sequences, and newsletters — never sends without your approval',
      'Analyzes uploaded documents, PDFs, competitor reports, and images for actionable insights',
      'Generates weekly performance reports with content published, leads spotted, competitor moves, and recommended actions',
      'Maintains brand voice consistency across all content using your Knowledge Base',
      'Runs daily automated routines: morning news scan, content drafts, competitor checks, evening summaries',
      'All outputs sent to Telegram for your review and approval before anything goes live',
    ],
    channels: ['sms', 'chat', 'telegram'],
    tools: [
      'Web Search (keyword research, trend tracking, SERP analysis)',
      'Web Scraper — Firecrawl (competitor monitoring, live web intelligence)',
      'Blog Monitor — Blogwatcher (RSS feeds, industry news, content alerts)',
      'Knowledge Base (brand voice, past content, audience profile)',
      'CRM (marketing lead logging, contact enrichment)',
      'URL Reader (article summarization, competitor page analysis)',
      'Image Analysis (competitor ad creative review, screenshot analysis)',
      'Document Analysis (PDFs, whitepapers, competitor reports)',
      'Email Drafting (cold outreach, follow-up sequences, newsletters)',
      'Escalates to Human (strategy decisions, high-value lead alerts)',
    ],
    requiredClawHubSkills: [
      'firecrawl-cli',  // Web intelligence — scrape, search, research
      'blogwatcher',    // RSS/blog monitoring — industry news feeds
    ],
    useCase: 'internal',
    visibility: 'public',
    variables: [
      ...
      { key: 'primary_keywords', label: 'Primary SEO Keywords', placeholder: 'AI marketing platform\nwhite-label AI\nagency automation', required: false, type: 'textarea' },
      { key: 'industry_rss_feeds', label: 'Industry RSS Feeds to Monitor', placeholder: 'https://blog.hubspot.com/rss\nhttps://searchengineland.com/feed', required: false, type: 'textarea' },
      { key: 'weekly_report_day', label: 'Weekly Report Day', placeholder: 'Monday', required: false },
    ],
  },
];
