      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;margin:0 auto;">
        ...
        <tr>
          <td style="background:#ffffff;padding:24px 40px 32px;text-align:center;">
            <a href="https://kyra.conversionsystem.com/agency/clients" style="display:inline-block;background:#4f46e5;color:#ffffff;text-decoration:none;font-weight:600;font-size:14px;padding:12px 28px;border-radius:8px;">
              View Full Dashboard →
            </a>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#f1f5f9;border-radius:0 0 12px 12px;padding:20px 40px;text-align:center;">
            <p style="margin:0;font-size:12px;color:#94a3b8;">
              This report was automatically generated by <strong>Kyra AI — Your AI Workforce Platform</strong> for ${escHtml(agencyName)}.<br/>
              Powered by <a href="https://kyra.conversionsystem.com" style="color:#4f46e5;">kyra.conversionsystem.com</a>
            </p>
          </td>
        </tr>
