...
// ============================================================================
// AI Workers — Unified Worker Gallery
//
// Single place to browse and apply AI workers to client containers.
...
//
// Flow: Browse → "Apply" → pick client → fill variables → one API call deploys it
// ============================================================================
    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Pick a worker → choose which client to configure → it deploys instantly.
        </p>
      </div>
      ...
      <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 mb-6 flex items-start gap-3">
        ...
        <div className="text-sm text-indigo-700">
          <strong>How it works:</strong> Click &quot;Apply&quot; on any worker, select which client to configure,
      ...
      {/* ── Premium Workers tab — full-page embed ── */}
      {category === 'premium' && (
        <div className="rounded-xl border border-amber-200 bg-amber-50/40 p-4 sm:p-6">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="font-bold text-gray-900">Premium Workers</h2>
              <p className="text-sm text-gray-500 mt-0.5">
                ...
                Free workers are in the By Role and By Industry tabs above.
              </p>
            </div>
          </div>
          ...
          >
            <div>
              <p className="font-semibold text-gray-900 text-sm">Browse Premium Workers →</p>
      ...
      {/* Worker Grid — only shown when not on Premium tab */}
      ...
      {!isSolo && !loadingClients && clients.length === 0 && (
        <div className="mt-8 bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3">
          ...
          <div className="text-sm text-amber-700">
            <strong>No active clients yet.</strong> You need to create a client first before applying a worker.{' '}
      ...
      <div className="mt-10 pt-8 border-t border-gray-200">
        <div className="flex items-start gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              <strong>Different from workers above.</strong> These aren&apos;t AI responses —
        ...
        {clientId ? (
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 text-center">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Apply a worker above to activate your AI, then come back to add Business Info.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="p-5 space-y-5">
          ...
          {isSolo ? (
            <div className="flex items-center gap-3 bg-indigo-50 rounded-xl p-3 border border-indigo-100">
              ...
              <div>
                ...
                <p className="text-xs text-indigo-600">🟢 Live — changes apply instantly</p>
              </div>
            </div>
          ) : (
            <div>
          ...
          {template.type === 'industry' && !template.variables && (
            <div className="text-center py-4 text-gray-400">
              ...
              <p className="text-xs">Loading worker fields...</p>
            </div>
          )}
