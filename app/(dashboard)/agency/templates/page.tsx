...
import { FileText, Plus, Clock, Zap, ArrowRight } from 'lucide-react';
...
const industryColors: Record<string, string> = {
  ...
  'General': 'border-zinc-500/50 bg-zinc-500/10 text-zinc-400',
};
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <Badge className={`mt-1.5 text-[10px] ${getIndustryColor(template.industry)}`}>
                        {template.industry}
                      </Badge>
                    </div>
                  </div>
