      ...
      <CardContent>
        <div
          className={`text-sm text-gray-700 leading-relaxed whitespace-pre-wrap ${
            mono ? 'font-mono text-xs bg-gray-50 rounded-lg p-3 border border-gray-100' : ''
          }`}
        >
          {value}
        </div>
...
const APP_NAME = 'Kyra — AI Workforce Platform for GHL Agencies';

const SHORT_DESC =
  'AI workforce platform for GHL agencies. AI workers reply in 60s, book appointments, update CRM, and escalate hot leads from one dashboard.';

const LONG_DESC = `Kyra is an AI Workforce Platform built specifically for agencies using GoHighLevel.

While GoHighLevel gives you the CRM, pipeline, and marketing infrastructure — Kyra gives you an AI workforce that works inside every client's GHL sub-account. Each AI worker responds to leads, qualifies prospects, books appointments, updates your pipeline, and escalates to humans when needed.
...
• One dashboard to manage AI workers for ALL your clients
...
• White-label branding — your agency's name, your client's AI worker
...
• Free: 1 AI worker
• Solo Pro: $39/mo — 1 AI worker (personal)
• Lite: $99/mo — 3 client AI workers
• Pro: $249/mo — 10 client AI workers
• Scale: $499/mo — 30 client AI workers

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ WHO THIS IS FOR
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

GHL agencies who want to add a recurring AI revenue stream. Charge clients $500–$5,000/month for a white-labeled AI worker. Kyra handles all the infrastructure — you set the price and keep the margin.

Most agencies bill $997–$1,997/month per AI worker. At $99/month for 3 client slots, your margin starts on day 1.
...
const PRICING_TIER =
  'Freemium — Free plan available. Paid plans from $39/mo (Solo Pro, 1 worker) to $499/mo (Scale, 30 clients). No credit card required to start.';
...
const SCREENSHOTS = [
  ...
  { label: 'Billing page — plan upgrade flow with annual/monthly toggle and live credit balance' },
];
    ...
    <div className="p-4 sm:p-6 md:p-8 max-w-5xl">
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm">
          All fields are copy-ready. Paste directly into the GHL marketplace submission form.
        </p>
      </div>
...
"This is Kyra — an AI workforce platform built for agencies on GoHighLevel."
...
"In the dashboard, I can manage AI workers for every one of my clients. Each one has its own personality, channels, and analytics."
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            {SCREENSHOTS.map((s) => (
              <ScreenshotItem key={s.label} label={s.label} />
            ))}
          </div>
        </CardContent>
      </Card>
