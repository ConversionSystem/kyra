    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-3">All 30 templates available inside the platform. <Link href="/solo" className="text-indigo-500 underline">Start free →</Link></p>
        </div>
      </div>
      <PublicFooter />
    </div>
