...
export default function ZapierPage() {
  return (
    <div className="bg-white min-h-screen text-gray-900">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-indigo-600 to-indigo-800 text-white px-4 py-20 text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.step} className="text-center">
                <div className="w-14 h-14 rounded-full bg-indigo-100 text-indigo-600 font-black text-2xl flex items-center justify-center mx-auto mb-4">
                  {s.step}
                </div>
