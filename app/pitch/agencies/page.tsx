      ...
      <div className="flex flex-col justify-center px-4 sm:px-8 lg:px-16 min-h-full max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            An AI worker for every client. Deployed in minutes, managed from one dashboard, 
      ...
      <div className="flex flex-col justify-center px-4 sm:px-8 lg:px-12 min-h-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <PricingCard
            ...
            clients={1}
            credits="50 welcome"
            features={['1 AI worker', 'All channels', 'CRM included', 'GHL integration', 'No credit card']}
            cta="Start Free →"
          />
          <PricingCard
            name="Lite"
            ...
            clients={3}
            credits="10,000"
            features={['3 AI workers', '21 industry templates', 'Analytics dashboard', 'Escalation alerts', 'Performance reports']}
            cta="Start Lite →"
          />
          <PricingCard
            name="Pro"
            ...
            credits="25,000"
            highlighted
            features={['10 AI workers', 'White-label branding', 'Custom templates', 'Revenue tracking', 'Priority support']}
            cta="Start Pro →"
          />
          <PricingCard
            name="Scale"
