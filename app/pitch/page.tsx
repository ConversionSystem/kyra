...
const SLIDES = [
  ...
  },
  {
    ...
    subtitle: 'Your cost to Kyra: $97–$497/month for all of them.',
    table: [
      { plan: 'Starter', cost: '$97/mo', clients: '5 clients', revenue: '$5,000/mo', margin: '$4,903' },
      { plan: 'Pro', cost: '$247/mo', clients: '15 clients', revenue: '$15,000/mo', margin: '$14,753' },
      { plan: 'Scale', cost: '$497/mo', clients: '50 clients', revenue: '$50,000/mo', margin: '$49,503' },
    ],
