...
const PLANS = [
  {
    ...
    features: [
      ...
      'AI Website Builder — 30+ page SEO site',
  ...
  },
  {
    ...
    features: [
      '3 client AI workers',
      'AI Website Builder — 30+ page site per client',
      'Lead capture forms + CRM sync',
...
const FAQ = [
  {
    ...
    a: 'Every client gets a 30+ page SEO website (generated by AI in minutes), an AI worker (chat widget that books appointments, captures leads, answers questions 24/7), a CRM that collects every lead, and access to the Growth Engine for ongoing SEO page generation.',
  },
  {
  ...
  },
  {
    ...
    a: 'Under 10 minutes. Enter the business info, Kyra generates a 30+ page website, deploys an AI worker trained on the business, and sets up the CRM. You can customize everything after.',
  },
  {
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <section className="py-20 text-center px-4">
        ...
        <p className="text-slate-400 text-lg max-w-xl mx-auto mb-6">
          Every plan includes a 30+ page website, AI worker, CRM, and lead capture per client. The math works from day one.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-20">
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-6 sm:p-8 text-center">
          ...
          <p className="text-slate-500 text-xs mt-1">Each client gets: 30+ page website + AI worker + CRM + lead capture</p>
        </div>
      </section>
          ...
          {[
            {
              ...
              truth: 'Enter the business name, industry, and location. Kyra generates a 30+ page website, deploys an AI worker, and sets up the CRM. Under 10 minutes. Zero code.',
            },
            {
              old: '"My clients already have websites."',
              truth: 'Most small business websites are 5 pages with zero SEO value. Kyra generates 30+ pages targeting local search terms — service pages, city pages, blog posts, FAQ. It\'s not just a website, it\'s a lead generation machine.',
            },
            {
              old: '"I don\'t have time to manage client sites."',
              truth: 'The Growth Engine suggests new pages based on search trends. One click to generate and publish. Sites grow themselves. You manage 30 clients from one dashboard.',
            },
            {
