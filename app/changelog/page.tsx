...
const UPDATES = [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { emoji: '🧹', text: 'Keyboard shortcuts removed' },
  ...
  },
  {
    ...
    title: 'Dispatch Intelligence & Algolia Search',
    desc: 'Smart delivery logistics and blazing-fast product search in one sprint.',
    items: [
