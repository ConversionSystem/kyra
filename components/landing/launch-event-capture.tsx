    ...
    return (
      <div className="flex flex-col items-center gap-3 py-4">
        ...
        <p className="text-slate-500 text-sm text-center max-w-sm">
          We&apos;ll reach out right after the demo with early access details.
        </p>
        <a
          href="https://twitter.com/intent/tweet?text=Just+signed+up+for+%40KyraAI+%E2%80%94+the+platform+that+turns+%40openclaw+into+agency+revenue.+Live+demo+March+16!+kyra.conversionsystem.com%2Fmarch-16"
          target="_blank"
