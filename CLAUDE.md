...
This project uses [gstack](https://github.com/garrytan/gstack) for AI-assisted development. Each teammate installs it once on their own machine.

**One-time setup on macOS:**

1. Install bun: `brew install oven-sh/bun/bun`
2. Clone gstack: `git clone --single-branch --depth 1 https://github.com/garrytan/gstack.git ~/.claude/skills/gstack`
3. Run setup: `cd ~/.claude/skills/gstack && ./setup`
