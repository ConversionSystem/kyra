...
Track new and lost backlinks pointing to the clinic's website. Monitor outreach success and detect organic link growth.
...
1. Search for backlinks using web_search and Firecrawl:
   - `link:{{WEBSITE}}` (Google)
   - `"{{CLINIC_NAME}}" -site:{{WEBSITE}}` (mentions that might have links)
...
| Type | Value | Examples |
|------|-------|---------|
| Editorial | ★★★★★ | Guest post on pet blog, news article mention |
| Directory | ★★★☆☆ | Yelp, Healthgrades, BBB listing |
...
| Spam | ☆☆☆☆☆ | Link farms, irrelevant foreign sites |

## What to Track Per Link

```json
{
  "url": "https://fremonpetblog.com/best-vets-2026",
  "anchor_text": "Aborn Pet Hospital",
  "link_type": "editorial",
...
If spam backlinks are detected (link farms, irrelevant foreign sites):
- Flag in report with ⚠️ warning
- Suggest: "Consider adding these domains to Google's disavow file"
- Track spam link count over time — increasing spam = potential negative SEO attack
